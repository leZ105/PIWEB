 ...
 */
class getCategorieMenuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieMenuRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieMenuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieMenuRepository.php';

        return $container->privates['App\\Repository\\CategorieMenuRepository'] = new \App\Repository\CategorieMenuRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

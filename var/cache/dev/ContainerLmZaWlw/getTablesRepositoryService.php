 ...
 */
class getTablesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TablesRepository' shared autowired service.
     *
     * @return \App\Repository\TablesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TablesRepository.php';

        return $container->privates['App\\Repository\\TablesRepository'] = new \App\Repository\TablesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

 ...
 */
class getRestoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RestoRepository' shared autowired service.
     *
     * @return \App\Repository\RestoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RestoRepository.php';

        return $container->privates['App\\Repository\\RestoRepository'] = new \App\Repository\RestoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

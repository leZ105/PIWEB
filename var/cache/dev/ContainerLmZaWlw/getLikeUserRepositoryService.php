 ...
 */
class getLikeUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LikeUserRepository' shared autowired service.
     *
     * @return \App\Repository\LikeUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LikeUserRepository.php';

        return $container->privates['App\\Repository\\LikeUserRepository'] = new \App\Repository\LikeUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
